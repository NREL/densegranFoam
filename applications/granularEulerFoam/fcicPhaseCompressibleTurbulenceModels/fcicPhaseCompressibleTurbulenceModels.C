...
#include "muIModel.H"
makeTurbulenceModel
(phaseModelPhaseCompressibleTurbulenceModel, RAS, muIModel);
...
makeTurbulenceModel
(phaseModelPhaseCompressibleTurbulenceModel, RAS, hypoplasticModel);

#include "biomassModel.H"
makeTurbulenceModel
(phaseModelPhaseCompressibleTurbulenceModel, RAS, biomassModel);
