...
Foam::biomassModels::frictionalStressModels::Schaeffer::Schaeffer
(
...
Foam::biomassModels::frictionalStressModels::Schaeffer::
frictionalPressure
(
...
Foam::tmp<Foam::volScalarField>
Foam::biomassModels::frictionalStressModels::Schaeffer::nu
(
    const phaseModel& phase,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax,
...
bool Foam::biomassModels::frictionalStressModels::Schaeffer::read()
{
