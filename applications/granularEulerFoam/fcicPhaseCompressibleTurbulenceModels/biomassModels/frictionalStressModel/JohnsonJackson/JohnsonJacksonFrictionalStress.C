...
Foam::biomassModels::frictionalStressModels::JohnsonJackson::
JohnsonJackson
(
...
Foam::tmp<Foam::volScalarField>
Foam::biomassModels::frictionalStressModels::JohnsonJackson::nu
(
    const phaseModel& phase,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax,
...
bool Foam::biomassModels::frictionalStressModels::JohnsonJackson::read()
{
