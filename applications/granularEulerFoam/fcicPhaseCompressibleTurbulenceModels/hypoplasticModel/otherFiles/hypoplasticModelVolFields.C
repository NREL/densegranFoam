...
Foam::RASModels::hypoplasticModel::RK4solver2D(symmTensor sigmahyp) const
{
  dimensionedScalar rk_h = U_.mesh().time().deltaT();

  scalar sh11("sh11", sigmahyp.component(tensor::XX));
  scalar sh12("sh12", sigmahyp.component(tensor::XY));
  scalar sh13("sh13", sigmahyp.component(tensor::XZ));
  scalar sh21("sh21", sigmahyp.component(tensor::YX));
  scalar sh22("sh22", sigmahyp.component(tensor::YY));
  scalar sh23("sh23", sigmahyp.component(tensor::YZ));

  sigmahyp = this->sigmahypfunc(sh11,sh12,sh13,sh21,sh22,sh23);
  scalar k1_11("k1_11", sigmahyp.component(tensor::XX));
  scalar k1_12("k1_12", sigmahyp.component(tensor::XY));
  scalar k1_13("k1_13", sigmahyp.component(tensor::XZ));
  scalar k1_21("k1_21", sigmahyp.component(tensor::YX));
  scalar k1_22("k1_22", sigmahyp.component(tensor::YY));
  scalar k1_23("k1_23", sigmahyp.component(tensor::YZ));
  ...
  scalar k2_11("k2_11", sigmahyp.component(tensor::XX));
  scalar k2_12("k2_12", sigmahyp.component(tensor::XY));
  scalar k2_13("k2_13", sigmahyp.component(tensor::XZ));
  scalar k2_21("k2_21", sigmahyp.component(tensor::YX));
  scalar k2_22("k2_22", sigmahyp.component(tensor::YY));
  scalar k2_23("k2_23", sigmahyp.component(tensor::YZ));
  ...
  scalar k3_11("k3_11", sigmahyp.component(tensor::XX));
  scalar k3_12("k3_12", sigmahyp.component(tensor::XY));
  scalar k3_13("k3_13", sigmahyp.component(tensor::XZ));
  scalar k3_21("k3_21", sigmahyp.component(tensor::YX));
  scalar k3_22("k3_22", sigmahyp.component(tensor::YY));
  scalar k3_23("k3_23", sigmahyp.component(tensor::YZ));
  ...
  scalar k4_11("k4_11", sigmahyp.component(tensor::XX));
  scalar k4_12("k4_12", sigmahyp.component(tensor::XY));
  scalar k4_13("k4_13", sigmahyp.component(tensor::XZ));
  scalar k4_21("k4_21", sigmahyp.component(tensor::YX));
  scalar k4_22("k4_22", sigmahyp.component(tensor::YY));
  scalar k4_23("k4_23", sigmahyp.component(tensor::YZ));
...
Foam::tmp<Foam::symmTensor>
Foam::RASModels::hypoplasticModel::sigmahypfunc(scalar sigmahyp11, scalar sigmahyp12, scalar sigmahyp13,
						  scalar sigmahyp21, scalar sigmahyp22, scalar sigmahyp23) const
{
