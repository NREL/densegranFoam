...
namespace viscosityModels
{
    ...
    addToRunTimeSelectionTable(viscosityModel, rheology, dictionary);
}
}
}
...
Foam::muJphiJModels::viscosityModels::rheology::rheology
(
...
Foam::muJphiJModels::viscosityModels::rheology::nu
(
