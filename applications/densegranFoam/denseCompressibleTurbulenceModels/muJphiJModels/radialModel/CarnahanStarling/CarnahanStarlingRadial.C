...
Foam::muJphiJModels::radialModels::CarnahanStarling::CarnahanStarling
(
...
Foam::muJphiJModels::radialModels::CarnahanStarling::g0
(
...
Foam::tmp<Foam::volScalarField>
Foam::muJphiJModels::radialModels::CarnahanStarling::g0prime
(
    const volScalarField& alpha,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax
