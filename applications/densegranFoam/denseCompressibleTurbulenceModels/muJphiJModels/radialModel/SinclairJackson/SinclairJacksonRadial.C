...
Foam::muJphiJModels::radialModels::SinclairJackson::SinclairJackson
(
...
Foam::muJphiJModels::radialModels::SinclairJackson::g0
(
...
Foam::tmp<Foam::volScalarField>
Foam::muJphiJModels::radialModels::SinclairJackson::g0prime
(
    const volScalarField& alpha,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax
