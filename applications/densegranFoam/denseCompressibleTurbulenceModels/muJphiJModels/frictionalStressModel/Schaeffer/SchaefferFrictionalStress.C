...
Foam::muJphiJModels::frictionalStressModels::Schaeffer::Schaeffer
(
...
Foam::muJphiJModels::frictionalStressModels::Schaeffer::
frictionalPressure
(
...
Foam::tmp<Foam::volScalarField>
Foam::muJphiJModels::frictionalStressModels::Schaeffer::nu
(
    const phaseModel& phase,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax,
...
bool Foam::muJphiJModels::frictionalStressModels::Schaeffer::read()
{
