...
Foam::muJphiJModels::frictionalStressModels::JohnsonJackson::
JohnsonJackson
(
...
Foam::tmp<Foam::volScalarField>
Foam::muJphiJModels::frictionalStressModels::JohnsonJackson::nu
(
    const phaseModel& phase,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax,
...
bool Foam::muJphiJModels::frictionalStressModels::JohnsonJackson::read()
{
